        ...
        with st.spinner(f'Loading {selected_year} {selected_race}...'):
            try:
                ...
                if 'No lap data' in err or 'misspelled' in err:
                    st.error(
                        f'No data found for **{selected_year} '
                        f'{selected_race} ({selected_session})**. '
                        f'Check the race name spelling or try a '
                        f'different year. Known working example: '
                        f'2023 · Bahrain · Race.'
                    )
                elif 'FastF1 failed' in err:
                    st.error(
                        f'FastF1 could not load this session. '
